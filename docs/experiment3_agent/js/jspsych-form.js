...
jsPsych.plugins['survey-html-form'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    // add submit button
    html += '<input type="submit" style="display: inline-block; margin:0 1em 3em 1em;" id="jspsych-survey-html-form-next" class="jspsych-btn jspsych-survey-html-form" value="'+trial.button_label+'"></input>';
